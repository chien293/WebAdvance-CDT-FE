...
export const Logo = ({ size = 36, width, height, ...props }) => (
  ...
  >
    ...
    ></path>
    <path fill="#388e3c" d="M7 10H41V38H7z"></path>
    <path
      fill="#fff"
      d="M28 36H36V38H28zM24 17A3 3 0 1 0 24 23 3 3 0 1 0 24 17z"
    ></path>
    <path fill="#a5d6a7" d="M16 21A2 2 0 1 0 16 25A2 2 0 1 0 16 21Z"></path>
    <path fill="#2e7d32" d="M7 10H41V12H7z"></path>
    <path fill="#ffab00" d="M36 38L28 38 32 42 40 42z"></path>
    <path
      fill="#a5d6a7"
